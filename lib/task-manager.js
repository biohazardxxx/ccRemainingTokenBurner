...
/**
 * Pick the highest-priority task with status "on".
 * Per-task maxBudgetUSD is still respected as a safety cap via claude --max-budget-usd.
 * Returns null if no suitable task is found.
 */
export function pickTask(data) {
